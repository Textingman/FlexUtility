                  ...
                  <div className="bg-[#3b3a41] text-white rounded-lg p-6">
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-consent" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive alert-related text messages from BWO Verify. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@bwoverify.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by BWO Verify.
                      </label>
                    </div>
                  </div>
